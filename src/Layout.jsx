  ...
  return (
    ...
    >
          ...
          {navItems.map((item) => (
            <li
              ...
              style={{
                ...
                marginBottom: "8px",
                backgroundColor:
                  activeTab === item.path ? "#282828" : "transparent",
          ...
          {isAuthenticated ? (
            ...
            <>
              <button
                ...
                onMouseEnter={(e) =>
                  (e.currentTarget.style.background = "#900")
                }
                onMouseLeave={(e) =>
                  (e.currentTarget.style.background = "#770505")
                }
              >
      ...
      <button
        ...
        onMouseLeave={(e) => {
          e.currentTarget.style.background = isSidebarOpen
            ? "transparent"
            : "rgba(40, 40, 40, 0.6)";
          e.currentTarget.style.borderColor = isSidebarOpen
            ? "none"
      ...
      >
        <span>
          {isSidebarOpen ? (
            <PanelLeftClose size={20} color="white" />
          ) : (
